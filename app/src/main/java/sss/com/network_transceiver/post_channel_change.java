...
public class post_channel_change extends AsyncTask<String,Integer,Integer>{
	/*動くコードはいいコード*/
	...
	private static final String url="http://vps.suzuyoshi-net.com/tomcat/transceiver-server/setGroup.jsp";
	...
	public post_channel_change (final Callback callback, final String requestCode){
	...
	protected Integer doInBackground(String... contents){
		...
		params.add(new BasicNameValuePair("user",Setting_class.user_name));
		params.add(new BasicNameValuePair("regId",Setting_class.token));
		params.add(new BasicNameValuePair("groupname",contents[0]));
